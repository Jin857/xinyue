...
class MallPriducts extends StatefulWidget {
  const MallPriducts({super.key});

  @override
  State<MallPriducts> createState() => _MallPriductsState();
}

class _MallPriductsState extends State<MallPriducts> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('图片选择 + 瀑布流 + 手势查看')),
      body: Column(
        children: [
          // ---------- 本地图片区域 ----------
